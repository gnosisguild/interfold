...
Committee key publication is valid through the DKG deadline. Interfold rejects later publication, so
a missed DKG deadline remains a supplier-side timeout.
