...
| 24  | **Mutable eligibility policy (AUD M-03)**            | Resolved | The first operator registration permanently locks ticket price, license thresholds, and minimum ticket policy, and the minimum ticket requirement can never be zero. |
