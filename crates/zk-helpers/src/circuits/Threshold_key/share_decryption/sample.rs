...
use crate::{
    Threshold_key::share_decryption::ShareDecryptionCircuitData, CiphernodesCommittee, CircuitsErrors,
};
...
impl ShareDecryptionCircuitData {
    ...
    pub fn generate_sample(
        ...
        for modulus_idx in 0..threshold_params.moduli().len() {
            ...
            // Party 0 collects shares from authorized parties
            ...
            for party_idx in 0..authorized_parties {
