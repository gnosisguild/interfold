...
use crate::Threshold_key::pk_aggregation::circuit::PkAggregationCircuit;
use crate::Threshold_key::pk_aggregation::circuit::PkAggregationCircuitData;
...
impl Computation for Inputs {
    ...
    fn compute(preset: Self::Preset, data: &Self::Data) -> Result<Self, Self::Error> {
        ...
        for pk in pk0.iter_mut().take(data.committee.a) {
            pk.reverse();
