...
//!
//! [`Sample`] produces a random BFV public key shares from H authorized parties and the aggregated public key;
//! the public key shares and aggregated public key are used as input for codegen and tests.

use crate::{
    Threshold_key::pk_aggregation::PkAggregationCircuitData, CiphernodesCommittee, CircuitsErrors,
};
...
mod tests {
    use crate::{
        ...
        Threshold_key::pk_aggregation::computation::Configs,
        Threshold_key::pk_aggregation::{Inputs, PkAggregationCircuitData},
    ...
    fn test_generate_sample() {
        ...
        assert_eq!(inputs.pk0.len(), sample.committee.a);
