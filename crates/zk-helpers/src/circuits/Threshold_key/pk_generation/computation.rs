...
use crate::Threshold_key::pk_generation::circuit::PkGenerationCircuitData;
use crate::Threshold_key::pk_generation::utils::deterministic_crp_crt_polynomial;
...
mod tests {
    ...
    #[test]
    fn bounds_compute_rejects_non_canonical_committee_a() {
        ...
        assert!(
            format!("{err:?}").contains("committee.a=8"),
