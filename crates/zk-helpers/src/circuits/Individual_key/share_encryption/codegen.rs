...
use crate::circuits::Individual_key::share_encryption::Configs;
use crate::circuits::Individual_key::share_encryption::Inputs;
use crate::circuits::Individual_key::share_encryption::ShareEncryptionCircuit;
use crate::circuits::Individual_key::share_encryption::ShareEncryptionCircuitData;
use crate::circuits::Individual_key::share_encryption::ShareEncryptionOutput;
...
mod tests {
    ...
    use crate::circuits::Individual_key::share_encryption::{Bounds, ShareEncryptionCircuitData};
    use crate::computation::Computation;
    ...
    fn test_configs_generation_contains_expected() {
        ...
        let bits = crate::circuits::Individual_key::share_encryption::Bits::compute(
            BfvPreset::InsecureThreshold512,
            &bounds,
        )
        .unwrap();
