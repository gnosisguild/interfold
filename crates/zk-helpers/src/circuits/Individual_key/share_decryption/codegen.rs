...
use crate::circuits::Individual_key::share_decryption::Configs;
use crate::circuits::Individual_key::share_decryption::Inputs;
use crate::circuits::Individual_key::share_decryption::ShareDecryptionCircuit;
use crate::circuits::Individual_key::share_decryption::ShareDecryptionCircuitData;
use crate::circuits::Individual_key::share_decryption::ShareDecryptionOutput;
...
mod tests {
    ...
    use crate::circuits::Individual_key::share_decryption::{Configs, ShareDecryptionCircuitData};
