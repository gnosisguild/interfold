...
/// Share-decryption circuit: proves correct decryption of H authorized parties' ciphertexts under the DKG secret key.
#[derive(Debug)]
...
/// Data for the share-decryption circuit: secret key, ciphertexts from external authorized
...
pub struct ShareDecryptionCircuitData {
    ...
    /// Per-authorized-party ciphertexts, length H, indexed by ascending authorized party_id.
    ...
    /// CRT modulus for an external authorized party.
    pub authorized_ciphertexts: Vec<Option<Vec<Ciphertext>>>,
