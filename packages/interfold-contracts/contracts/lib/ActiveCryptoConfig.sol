...
// Auto-generated by scripts/build-circuits.ts for secure-8192/small.
library ActiveCryptoConfig {
    ...
    uint8 internal constant COMMITTEE_SIZE = 2;
    uint32 internal constant T = 9;
    uint32 internal constant H = 10;
    uint32 internal constant N = 19;
