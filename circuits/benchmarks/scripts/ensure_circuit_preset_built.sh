#!/usr/bin/env bash
# Ensure Noir circuit artifacts exist for a benchmark preset (insecure-512 | secure-8192 | secure-16384).
#
...
usage() {
    echo "Usage: $0 <insecure-512|secure-8192|secure-16384> [--committee minimum|micro|small] [--force-build] [--verbose]"
}
