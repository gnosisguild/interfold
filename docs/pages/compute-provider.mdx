...
[Boundless](https://docs.boundless.network/) as the CP.
...
4. Configure your `interfold.config.yaml` as shown in the
   [CRISP setup guide](/CRISP/setup#boundless-configuration)

For more details, see the [Boundless documentation](https://docs.boundless.network/).
