...
description:
  'Implement the IE3Program interface — validate, publishInput, and verify functions for your
  on-chain E3 program'
---
...
[mockup](https://github.com/theinterfold/interfold/blob/cf50fd6c10f0df8f03eecfd19cedc17b051e72a6/packages/interfold-contracts/contracts/test/MockE3Program.sol#L9)
or check out the
...
The verify function receives the output hash, its SAFE commitment, and the compute provider proof.
The verified statement must bind both values.
