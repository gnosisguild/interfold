...
The journal binds the proof to the output hash, SAFE commitment, inputs, and parameters. A
front-runner cannot replace the commitment while reusing a valid proof.
