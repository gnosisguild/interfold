...
- `is_first_vote` — whether this input extends an earlier entry in the slot, or nothing
...
const { encryptedVote, inputs } = generator.generateInputs(previousCiphertext, publicKey, voteCoefficients, keepPrevious)
```
